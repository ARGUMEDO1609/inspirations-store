...
- `server/`: API Rails 8 con PostgreSQL, JWT, Pundit y ActiveAdmin. Expone `api/v1` y maneja pagos vía Wompi, está sincronizado con Action Cable y centraliza errores mediante `ApiResponses`.
...
- Se mantiene el carrito, checkout e historial de pedidos con toques de UX: loaders, notificaciones y mensajes específicos sobre stock, direcciones o pagos (contra entrega y Wompi).
